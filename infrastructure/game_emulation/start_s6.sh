...
cid=$(docker run --net=none --name ${full_name} --memory=2048m --cpu-shares=10 -d ructfe2014:${name} /usr/bin/python3.4 /root/service.py 6666 0 0)

ip="10.$((60 + team_num / 256)).$((team_num % 256)).106/24"
